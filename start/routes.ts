...
const TrainingPathsController = () => import('#controllers/training_paths_controller')
const TrainingManualsController = () => import('#controllers/training_manuals_controller')
